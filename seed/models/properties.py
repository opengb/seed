...
class PropertyState(models.Model):
    ...
    gross_floor_area_si = QuantityField('m**2', null=True, blank=True)
    ...
    conditioned_floor_area_si = QuantityField('m**2', null=True, blank=True)
    occupied_floor_area = models.FloatField(null=True, blank=True)
    occupied_floor_area_si = QuantityField('m**2', null=True, blank=True)
    ...
    site_eui_si = QuantityField('GJ/m**2/year', null=True, blank=True)
    ...
    source_eui_weather_normalized_si = QuantityField('GJ/m**2/year', null=True, blank=True)
    site_eui_weather_normalized = models.FloatField(null=True, blank=True)
    site_eui_weather_normalized_si = QuantityField('GJ/m**2/year', null=True, blank=True)
    source_eui = models.FloatField(null=True, blank=True)
    source_eui_si = QuantityField('GJ/m**2/year', null=True, blank=True)
